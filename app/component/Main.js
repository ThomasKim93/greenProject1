    ...
    const dashboardItems = [
        {
            ...
            imageURL: '../img/Dashboard1.svg', // 이미지 URL 추가
        },
        {
            ...
            imageURL: '../img/Dashboard2.svg', // 이미지 URL 추가
        },
        {
            ...
            imageURL: '../img/Dashboard3.svg', // 이미지 URL 추가
        },
    ];
    ...
    return (
        ...
        <div className={mainSt.main}>
            ...
            <div className={mainSt.top}>
                ...
                <img src='../img/mediamaintop.svg' className={mainSt.topmediaimg}>
            ...
            <div className={mainSt.hidden}>
                <div className={mainSt.container}>
                    <div className={mainSt.marquee}>
                        <div className={mainSt.ani}>
                            <div className={mainSt.aniimg}>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper1.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper2.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper3.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper4.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper5.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper6.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper7.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper8.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper9.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                                <div className={mainSt.anilist}>
                                    <div className={mainSt.anilistitem}>
                                        <img src='../img/swiper10.png' className={mainSt.anilistitemimg}></img>
                                    </div>
                                </div>
                            </div>
                            <div className={mainSt.aniimg}>
